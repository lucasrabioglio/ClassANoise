...
ax1.plot(A_est_Luc,'--o',markersize = 5, color = 'tab:green', label = 'Est. Lucas')
...
ax1.plot(vec_A_ini,'--o', markersize = 5, color = 'black', label = 'Est. Propuesto')
ax1.axhline(xmin = 0,xmax = n,y = A, linestyle = '--',color = 'green',linewidth = 1)
ax1.grid(True)

ax2.set_ylabel(r'$\Gamma$ Estimado',fontsize = 14)
ax2.plot(r_est_Luc,'--o',markersize = 5, color = 'tab:green', label = 'Est. Lucas')
...
ax2.plot(vec_r_ini,'--o', markersize = 5, color = 'black', label = 'Est. Propuesto')
ax2.axhline(xmin = 0,xmax = n,y = r, linestyle = '--',color = 'green',linewidth = 1)
ax2.grid(True)

ax3.set_ylabel(r'$\sigma_{G}^{2}$ Estimado',fontsize = 14)
ax3.plot(Sigmag2_est_Luc,'--o',markersize = 5, color = 'tab:green', label = 'Est. Lucas')
ax3.plot(vec_Sigmag2_ini,'--o', markersize = 5, color = 'black', label = 'Est. Propuesto')
ax3.axhline(xmin = 0,xmax = n,y = Sigma_G_sq, linestyle = '--',color = 'green',linewidth = 1)
...
#---------------------------------------------------------------------------------
#------------------------- Flecha Gamma -----------------------------------------
ax2.annotate(r'$\Gamma $', xy=(0.5, r), xytext=(0, 0.5),
                   arrowprops=dict(arrowstyle="->",
                                   connectionstyle="angle3,angleA=0,angleB=-90"),
                                   bbox=dict(boxstyle="round", fc='tab:green',alpha = 0.5,color = 'tab:green'))
