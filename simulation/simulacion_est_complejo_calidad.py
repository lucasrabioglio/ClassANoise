...
ax1.set_xlabel('Iteración (N = 2000 Muestras)',fontsize = 14)
ax1.grid(True)
...
ax2A.set_ylabel(r'Est. $\Gamma$',fontsize = 14)
ax2A.plot(r_est_Kane,'--o',markersize = 5, color = 'tab:blue', label = 'Est. Kanemoto')
ax2A.plot(K_est_Zabin/A_est_Zabin,'--o',markersize = 5, color = 'tab:red', label = 'Est. Zabin-Poor')
ax2A.plot(K_est_EM/A_est_EM,'--o',markersize = 5, color = 'tab:orange', label = 'Est. EM')
ax2A.plot(vec_r_ini,'--o', markersize = 5, color = 'black', label = 'Est. Simple')
ax2A.plot(r_est_Luc,'--o', markersize = 5, color = 'green', label = 'Est. Propuesto')
ax2A.axhline(xmin = 0,xmax = n,y = r, linestyle = '--',color = 'red',linewidth = 1.5, label = 'Valor real')
ax2A.grid(True)

ax2B.set_ylabel(r'Est. $\Gamma$',fontsize = 14)
ax2B.plot(K_est_EM/A_est_EM,'--o',markersize = 5, color = 'tab:orange', label = 'Est. EM')
ax2B.plot(vec_r_ini,'--o', markersize = 5, color = 'black', label = 'Est. Simple')
ax2B.plot(r_est_Luc,'--o', markersize = 5, color = 'green', label = 'Est. Propuesto')
ax2B.axhline(xmin = 0,xmax = n,y = r, linestyle = '--',color = 'red',linewidth = 1.5, label = 'Valor real')
ax2B.set_xlabel('Iteración (N = 2000 Muestras)',fontsize = 14)
ax2B.grid(True)
"""
...
ax3.set_xlabel('Iteración (N = 2000 Muestras)',fontsize = 14)
ax3.grid(True)
...
ax2A.legend(loc = 1, fontsize = 8)
#ax2B.legend(loc = 1, fontsize = 8)
